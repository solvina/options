...
class PartialFillDetectionServiceTest {
    ...
    @Test
    fun `issue 1 - both legs fill successfully`() =
        runTest {
            ...
            val result =
                service.closeWithPartialFillDetection(
                    testSpread,
    ...
    @Test
    fun `issue 1 - sold leg fills but bought leg fails`() =
        runTest {
    ...
    @Test
    fun `issue 1 - bought leg fills but sold leg fails`() =
        runTest {
    ...
    @Test
    fun `issue 1 - both legs timeout without filling`() =
        runTest {
    ...
    @Test
    fun `issue 1 - order placement exception`() =
        runTest {
            ...
            assertTrue(
                result.reason.contains("failed") ||
                    result.reason.contains("Exception"),
            )
        }
}
