...
interface BarStorePort {
    suspend fun writeBar(symbol: Symbol, bar: FiveMinuteBar)
    suspend fun writeBars(symbol: Symbol, bars: List<FiveMinuteBar>)
    suspend fun readBars(symbol: Symbol, from: Instant, to: Instant): List<FiveMinuteBar>
     ...
     * with a count of 0.
     */
    suspend fun coverageByDay(symbol: Symbol, from: LocalDate, to: LocalDate): Map<LocalDate, Int>
}
